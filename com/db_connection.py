...
class DataBaseConnection:
    ...
    def create_db_connection(self, **kwargs):
        functions.verbose(outputMode=kwargs.get('logOutputMode'), outputMessage="[" + self.__name__ + "] " + " create_db_connection() " + " Enter", logName="main")
        ...
        if db_type == 'mysql':
            try:
                ...
                functions.verbose(outputMode=kwargs.get('logOutputMode'), outputMessage="[" + self.__name__ + "] " + " create_db_connection() " + error_message, logName="main")
        ...
        functions.verbose(outputMode=kwargs.get('logOutputMode'), outputMessage="[" + self.__name__ + "] " + " create_db_connection() " + "Exit", logName="main")
        return db_connection


    def execute_query(self, **kwargs):
        functions.verbose(outputMode=kwargs.get('logOutputMode'), outputMessage="[" + self.__name__ + "] " + " execute_query() " + "Enter", logName="main")
        try:
            ...
            functions.verbose(outputMode=kwargs.get('logOutputMode'), outputMessage="[" + self.__name__ + "] " + " execute_query() " + error_message, logName="main")
            sys.exit(error_message)
        ...
        cursor.close()
        functions.verbose(outputMode=kwargs.get('logOutputMode'),  outputMessage="[" + self.__name__ + "] " + " execute_query() " + "Exit", logName="main")
        return returnArray
